...
export function WaifuSelectPanel({
    isOpen,
    onClose,
    waifus,
    activeWaifu,
    onSelect,
}: WaifuSelectPanelProps) {
    if (!isOpen) return null;

    return (
        <div className="panel-overlay" onClick={onClose}>
            <div
                className="panel waifu-select-panel"
                        ...
                        waifus.map((waifu) => (
                            ...
                            >
                                ...
                                <div className="waifu-card-info">
                                    <span className="waifu-name">
                                        {waifu.name}
                                    </span>
                                    <span className="waifu-lvl">
                                        Lv.{waifu.stats.level}
                                    </span>
