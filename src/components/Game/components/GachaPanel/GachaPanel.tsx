...
export function GachaPanel({
    ...
    const getAvailablePool = () => {
        const maxedIds = new Set(
            ownedWaifus.filter((w) => w.isMaxed()).map((w) => w.id),
        );
        ...
        <div className="panel-overlay" onClick={handleClose}>
            ...
            >
                ...
                <div className="gacha-tabs">
                    ...
                    <button
                        className={`gacha-tab ${activeTab === "pool" ? "active" : ""}`}
                    ...
                    {activeTab === "summon" ? (
                        <>
                            {isAnimating ? (
                                ...
                                <div
                                    className={`gacha-result rarity-${result.waifu.rarity} ${result.isDuplicate ? "duplicate" : ""}`}
                                >
                                    {result.isDuplicate && (
                                        <div className="duplicate-banner">
                                            <span>⬆️ {t("ui.duplicate")}</span>
                                    ...
                                    <div className="result-waifu">
                                        <img
                                            src={result.waifu.image}
                                            alt={result.waifu.name}
                                        />
                                        ...
                                        {result.isDuplicate && (
                                            <span className="dup-count-badge">
                                                {result.waifu.duplicateCount}/20
                                            </span>
                                        )}
                                    </div>
                                    ...
                                    <div className="waifu-stats-preview">
                                        <span>
                                            👆 {result.waifu.getClickPower()}
                                        </span>
                                        <span>
                                            ⚙️ {result.waifu.getAutoClick()}
                                        </span>
                                        <span>
                                            ⚔️{" "}
                                            {(
                                                result.waifu.getCritChance() *
                                                100
                                            ).toFixed(1)}
                                            %
                                        </span>
                                ...
                                <>
                                        ...
                                        {dropInfo ? (
                                            <>
                                                {Object.entries(
                                                    ...
                                                    <div
                                                        key={rarity}
                                                        className={`rate-row rarity-${rarity}`}
                                                    >
                                            ...
                                            <p className="empty-pool-warning">
                                                ⚠️ {t("ui.poolEmptyWarning")}
                                            </p>
                                        )}
                                    </div>
                                    ...
                                    <div className="gacha-action">
                                        <div className="cost-display">
                                            <span>💎 10 {t("ui.essence")}</span>
                                            <span className="player-essence">
                                                {t("ui.youHave")}: {essence} ✨
                                            </span>
                                        </div>
                                        <button
