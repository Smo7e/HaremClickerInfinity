...
export function WaifuDetailPanel({
    isOpen,
    onClose,
    waifu,
}: WaifuDetailPanelProps) {
    ...
    return (
        <div className="panel-overlay" onClick={onClose}>
            <div
                className="panel waifu-detail-panel"
            ...
            >
                ...
                <div className="panel-content waifu-detail-content">
                    <div className="waifu-detail-portrait">
                        ...
                        />
                        <div
                            className="waifu-detail-element"
                            title={waifu.element}
                        >
                            {ELEMENT_ICONS[waifu.element]}
                        </div>
                        <div
                            className="waifu-detail-rarity"
                    ...
                    <div className="waifu-detail-info">
                        ...
                        <div className="waifu-stats-detail">
                            ...
                            <div className="exp-bar-detail">
                                <div
                                    ...
                                    style={{
                                        width: `${(waifu.stats.exp / waifu.stats.expToNext) * 100}%`,
                                    }}
                                />
                            ...
                            <div className="stat-row-detail">
                                ...
                                <span className="stat-value">
                                    {(waifu.getCritChance() * 100).toFixed(1)}%
                                </span>
                            </div>
                            ...
                            <div className="stat-row-detail">
                                ...
                                <span className="stat-value">
                                    {waifu.getCritMultiplier().toFixed(1)}x
                                </span>
                            </div>
                        ...
                        <div className="waifu-stats-total">
                            ...
                            <p>
                                👆 {waifu.stats.clicksGenerated}{" "}
                                {t("ui.clicks")}
                            </p>
                            <p>
                                ⚔️ {waifu.stats.totalDamage} {t("ui.damage")}
                            </p>
                        </div>
                    </div>
                </div>
